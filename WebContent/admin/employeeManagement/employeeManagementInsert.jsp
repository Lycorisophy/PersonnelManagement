...
<script type='text/javascript' src='${basePath}/js/jquery.js'></script>            
 ...
 function insert(){		
	    ...
	    $.ajax({
	        ...
	        url:"${basePath}/controller/employeeController/employeeControllerInsert.jsp",//请求地址
	        data:{"tname":tname,"data2":data2,"data3":data3,"data4":data4,"data5":data5,"data6":data6,"data7":data7,"data8":data8,"data9":data9,"data10":data10,"data11":data11,"data12":data12,"data13":data13},//传递给controller的json数据
