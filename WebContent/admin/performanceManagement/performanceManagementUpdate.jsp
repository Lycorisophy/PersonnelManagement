...
function update(count){	
    ...
    $.ajax({
        ...
        url:"${basePath}/controller/performanceController/performanceControllerUpdate.jsp",//请求地址
        data:{"tname":tname,"data1":data1,"data2":data2,"data3":data3,"data4":data4,"data5":data5,"data6":data6,"data7":data7},//传递给controller的json数据
