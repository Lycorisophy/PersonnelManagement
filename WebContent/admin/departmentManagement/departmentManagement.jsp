 ...
 <c:when  test="${sessionScope.isAdmin == 1 && sessionScope.notAdmin == 0}">
		<li  class="s-mod-item" w="450" h="350" l="50" t="0" bg="#aa5096" cbg="#922a7b">
			<div class="s-mod-wrap">
				...
				<div class="s-mod-cur"><span  onclick="javascript:window.open('${basePath}/admin/departmentManagement/departmentManagementInsert.jsp','_self')">实现添加部门</span></div>
			</div>
		</li>
		<li  class="s-mod-item" w="450" h="350" l="550" t="0" bg="#FFD302" cbg="#EAC203">
			<div class="s-mod-wrap">
				<div class="s-mod-def"><span>删除部门</span></div>
				<div class="s-mod-cur"><span  onclick="javascript:window.open('${basePath}/admin/departmentManagement/departmentManagementDelete.jsp','_self')">删除部门功能</span></div>
			</div>
		</li>
		<li  class="s-mod-item" w="450" h="350" l="50" t="400" bg="#0C6DB2" cbg="#09578E">
			<div class="s-mod-wrap">
				<div class="s-mod-def"><span>更改部门</span></div>
				<div class="s-mod-cur"><span  onclick="javascript:window.open('${basePath}/admin/departmentManagement/departmentManagementUpdate.jsp','_self')">可以改变部门信息</span></div>
			</div>
		</li>
		<li  class="s-mod-item" w="450" h="350" l="550" t="400" bg="#33ac5b" cbg="#209747">
			<div class="s-mod-wrap">
				<div class="s-mod-def"><span>查询部门</span></div>
				<div class="s-mod-cur"><span  onclick="javascript:window.open('${basePath}/admin/departmentManagement/departmentManagementSelect.jsp','_self')">查询部门</span></div>
			</div>
		</li>
		  </c:when>
       </c:choose> 	
...
<a class="btn-org" href="${basePath}/text/department" download="部门说明"
