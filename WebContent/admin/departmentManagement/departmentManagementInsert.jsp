 ...
 <script>
 	function insert(){		
 	    ...
 	    $.ajax({
 	        ...
 	        url:"${basePath}/controller/departmentController/departmentControllerInsert.jsp",//请求地址
 	        data:{"tname":tname,"data2":data2,"data3":data3,"data4":data4},//传递给controller的json数据
