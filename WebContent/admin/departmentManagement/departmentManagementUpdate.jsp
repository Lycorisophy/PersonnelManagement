...
function update(count){	
    ...
    $.ajax({
        ...
        url:"${basePath}/controller/departmentController/departmentControllerUpdate.jsp",//请求地址
        data:{"tname":tname,"data1":data1,"data2":data2,"data3":data3,"data4":data4},//传递给controller的json数据
