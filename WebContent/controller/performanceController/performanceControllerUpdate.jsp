...
String performance=request.getParameter("data5");
...
int err=0;
try{
String sql="update "+tableName+" set userID='"+userID+"',startTime='"+startTime+"',endTime='"+endTime+"' ,performance='"+performance+"' ,notes='"+notes+"' where id="+id;
